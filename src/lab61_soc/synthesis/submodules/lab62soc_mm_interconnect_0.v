...
module lab62soc_mm_interconnect_0 (
		...
		input  wire        sdram_plll_c0_clk,                              //                            sdram_plll_c0.clk
		...
		output wire [1:0]  sdram_plll_pll_slave_address,                   //                     sdram_plll_pll_slave.address
		output wire        sdram_plll_pll_slave_write,                     //                                         .write
		output wire        sdram_plll_pll_slave_read,                      //                                         .read
		input  wire [31:0] sdram_plll_pll_slave_readdata,                  //                                         .readdata
		output wire [31:0] sdram_plll_pll_slave_writedata,                 //                                         .writedata
	...
	wire   [31:0] sdram_plll_pll_slave_agent_m0_readdata;                                             // sdram_plll_pll_slave_translator:uav_readdata -> sdram_plll_pll_slave_agent:m0_readdata
	wire          sdram_plll_pll_slave_agent_m0_waitrequest;                                          // sdram_plll_pll_slave_translator:uav_waitrequest -> sdram_plll_pll_slave_agent:m0_waitrequest
	wire          sdram_plll_pll_slave_agent_m0_debugaccess;                                          // sdram_plll_pll_slave_agent:m0_debugaccess -> sdram_plll_pll_slave_translator:uav_debugaccess
	wire   [27:0] sdram_plll_pll_slave_agent_m0_address;                                              // sdram_plll_pll_slave_agent:m0_address -> sdram_plll_pll_slave_translator:uav_address
	wire    [3:0] sdram_plll_pll_slave_agent_m0_byteenable;                                           // sdram_plll_pll_slave_agent:m0_byteenable -> sdram_plll_pll_slave_translator:uav_byteenable
	wire          sdram_plll_pll_slave_agent_m0_read;                                                 // sdram_plll_pll_slave_agent:m0_read -> sdram_plll_pll_slave_translator:uav_read
	wire          sdram_plll_pll_slave_agent_m0_readdatavalid;                                        // sdram_plll_pll_slave_translator:uav_readdatavalid -> sdram_plll_pll_slave_agent:m0_readdatavalid
	wire          sdram_plll_pll_slave_agent_m0_lock;                                                 // sdram_plll_pll_slave_agent:m0_lock -> sdram_plll_pll_slave_translator:uav_lock
	wire   [31:0] sdram_plll_pll_slave_agent_m0_writedata;                                            // sdram_plll_pll_slave_agent:m0_writedata -> sdram_plll_pll_slave_translator:uav_writedata
	wire          sdram_plll_pll_slave_agent_m0_write;                                                // sdram_plll_pll_slave_agent:m0_write -> sdram_plll_pll_slave_translator:uav_write
	wire    [2:0] sdram_plll_pll_slave_agent_m0_burstcount;                                           // sdram_plll_pll_slave_agent:m0_burstcount -> sdram_plll_pll_slave_translator:uav_burstcount
	wire          sdram_plll_pll_slave_agent_rf_source_valid;                                         // sdram_plll_pll_slave_agent:rf_source_valid -> sdram_plll_pll_slave_agent_rsp_fifo:in_valid
	wire  [106:0] sdram_plll_pll_slave_agent_rf_source_data;                                          // sdram_plll_pll_slave_agent:rf_source_data -> sdram_plll_pll_slave_agent_rsp_fifo:in_data
	wire          sdram_plll_pll_slave_agent_rf_source_ready;                                         // sdram_plll_pll_slave_agent_rsp_fifo:in_ready -> sdram_plll_pll_slave_agent:rf_source_ready
	wire          sdram_plll_pll_slave_agent_rf_source_startofpacket;                                 // sdram_plll_pll_slave_agent:rf_source_startofpacket -> sdram_plll_pll_slave_agent_rsp_fifo:in_startofpacket
	wire          sdram_plll_pll_slave_agent_rf_source_endofpacket;                                   // sdram_plll_pll_slave_agent:rf_source_endofpacket -> sdram_plll_pll_slave_agent_rsp_fifo:in_endofpacket
	wire          sdram_plll_pll_slave_agent_rsp_fifo_out_valid;                                      // sdram_plll_pll_slave_agent_rsp_fifo:out_valid -> sdram_plll_pll_slave_agent:rf_sink_valid
	wire  [106:0] sdram_plll_pll_slave_agent_rsp_fifo_out_data;                                       // sdram_plll_pll_slave_agent_rsp_fifo:out_data -> sdram_plll_pll_slave_agent:rf_sink_data
	wire          sdram_plll_pll_slave_agent_rsp_fifo_out_ready;                                      // sdram_plll_pll_slave_agent:rf_sink_ready -> sdram_plll_pll_slave_agent_rsp_fifo:out_ready
	wire          sdram_plll_pll_slave_agent_rsp_fifo_out_startofpacket;                              // sdram_plll_pll_slave_agent_rsp_fifo:out_startofpacket -> sdram_plll_pll_slave_agent:rf_sink_startofpacket
	wire          sdram_plll_pll_slave_agent_rsp_fifo_out_endofpacket;                                // sdram_plll_pll_slave_agent_rsp_fifo:out_endofpacket -> sdram_plll_pll_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> sdram_plll_pll_slave_agent:cp_valid
	wire  [105:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sdram_plll_pll_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // sdram_plll_pll_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [14:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sdram_plll_pll_slave_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> sdram_plll_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> sdram_plll_pll_slave_agent:cp_endofpacket
	...
	wire          sdram_plll_pll_slave_agent_rp_valid;                                                // sdram_plll_pll_slave_agent:rp_valid -> router_005:sink_valid
	wire  [105:0] sdram_plll_pll_slave_agent_rp_data;                                                 // sdram_plll_pll_slave_agent:rp_data -> router_005:sink_data
	wire          sdram_plll_pll_slave_agent_rp_ready;                                                // router_005:sink_ready -> sdram_plll_pll_slave_agent:rp_ready
	wire          sdram_plll_pll_slave_agent_rp_startofpacket;                                        // sdram_plll_pll_slave_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          sdram_plll_pll_slave_agent_rp_endofpacket;                                          // sdram_plll_pll_slave_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          sdram_plll_pll_slave_agent_rdata_fifo_src_valid;                                    // sdram_plll_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] sdram_plll_pll_slave_agent_rdata_fifo_src_data;                                     // sdram_plll_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          sdram_plll_pll_slave_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_003:in_0_ready -> sdram_plll_pll_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> sdram_plll_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> sdram_plll_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                                  // sdram_plll_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> sdram_plll_pll_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sdram_plll_pll_slave_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sdram_plll_pll_slave_agent_m0_address),          // avalon_universal_slave_0.address
		.uav_burstcount         (sdram_plll_pll_slave_agent_m0_burstcount),       //                         .burstcount
		.uav_read               (sdram_plll_pll_slave_agent_m0_read),             //                         .read
		.uav_write              (sdram_plll_pll_slave_agent_m0_write),            //                         .write
		.uav_waitrequest        (sdram_plll_pll_slave_agent_m0_waitrequest),      //                         .waitrequest
		.uav_readdatavalid      (sdram_plll_pll_slave_agent_m0_readdatavalid),    //                         .readdatavalid
		.uav_byteenable         (sdram_plll_pll_slave_agent_m0_byteenable),       //                         .byteenable
		.uav_readdata           (sdram_plll_pll_slave_agent_m0_readdata),         //                         .readdata
		.uav_writedata          (sdram_plll_pll_slave_agent_m0_writedata),        //                         .writedata
		.uav_lock               (sdram_plll_pll_slave_agent_m0_lock),             //                         .lock
		.uav_debugaccess        (sdram_plll_pll_slave_agent_m0_debugaccess),      //                         .debugaccess
		.av_address             (sdram_plll_pll_slave_address),                   //      avalon_anti_slave_0.address
		.av_write               (sdram_plll_pll_slave_write),                     //                         .write
		.av_read                (sdram_plll_pll_slave_read),                      //                         .read
		.av_readdata            (sdram_plll_pll_slave_readdata),                  //                         .readdata
		.av_writedata           (sdram_plll_pll_slave_writedata),                 //                         .writedata
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
		.av_byteenable          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) sdram_plll_pll_slave_agent (
		.clk                     (clk_0_clk_clk),                                         //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (sdram_plll_pll_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (sdram_plll_pll_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (sdram_plll_pll_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (sdram_plll_pll_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (sdram_plll_pll_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (sdram_plll_pll_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (sdram_plll_pll_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (sdram_plll_pll_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (sdram_plll_pll_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (sdram_plll_pll_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (sdram_plll_pll_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (sdram_plll_pll_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (sdram_plll_pll_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (sdram_plll_pll_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (sdram_plll_pll_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (sdram_plll_pll_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (sdram_plll_pll_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (sdram_plll_pll_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (sdram_plll_pll_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (sdram_plll_pll_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (sdram_plll_pll_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (sdram_plll_pll_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (sdram_plll_pll_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (sdram_plll_pll_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (sdram_plll_pll_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (sdram_plll_pll_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                     // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                     //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                      //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                     //                .error
		.rdata_fifo_src_ready    (sdram_plll_pll_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sdram_plll_pll_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (sdram_plll_pll_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                 //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                   //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sdram_plll_pll_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                         //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (sdram_plll_pll_slave_agent_rf_source_data),             //        in.data
		.in_valid          (sdram_plll_pll_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (sdram_plll_pll_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (sdram_plll_pll_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (sdram_plll_pll_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (sdram_plll_pll_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (sdram_plll_pll_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (sdram_plll_pll_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (sdram_plll_pll_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (sdram_plll_pll_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                 // (terminated)
		.csr_read          (1'b0),                                                  // (terminated)
		.csr_write         (1'b0),                                                  // (terminated)
		.csr_readdata      (),                                                      // (terminated)
	...
	lab62soc_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (sdram_plll_pll_slave_agent_rp_ready),            //      sink.ready
		.sink_valid         (sdram_plll_pll_slave_agent_rp_valid),            //          .valid
		.sink_data          (sdram_plll_pll_slave_agent_rp_data),             //          .data
		.sink_startofpacket (sdram_plll_pll_slave_agent_rp_startofpacket),    //          .startofpacket
		.sink_endofpacket   (sdram_plll_pll_slave_agent_rp_endofpacket),      //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_clk           (sdram_plll_c0_clk),                              //       out_clk.clk
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_clk            (sdram_plll_c0_clk),                              //        in_clk.clk
	...
	lab62soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                   // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (sdram_plll_pll_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (sdram_plll_pll_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (sdram_plll_pll_slave_agent_rdata_fifo_src_ready), //         .ready
	...
	lab62soc_mm_interconnect_0_avalon_st_adapter_005 #(
		...
		.in_clk_0_clk   (sdram_plll_c0_clk),                       // in_clk_0.clk
